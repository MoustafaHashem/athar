...
export default function LandingPage() {
  ...
  const instructorsList: InstructorInfo[] = [
    {
      name: "ق. أشرف أنور",
      specialRole: "قائد هيئة تدريب",
      bio: [
        "مدير عام المعلومات وقواعد البيانات بشركة جابكو للبترول",
        "قائد ومحاضر متميز في التنمية البشرية وقيادة الذات والإرث الكشفي",
        "عضو مكتب تدريب جامعة عين شمس",
        "قائد مكتب تدريب جوالة هندسة عين شمس",
        "قائد عشائر جامعة عين شمس سابقاً",
      ],
      imagePath: "/images/instructors/ashraf-anwar.png",
      firstOrder: 1,
      sessions: ["المحاضرة #1", "المحاضرة #2", "المحاضرة #7", "المحاضرة #10"],
    },
    {
      name: "ق. فاطمة الزهراء",
      bio: [
        "Senior Sustainability Engineer",
        "متخصصة في إدارة الوقت والأولويات والتطوير المؤسسي",
        "عضو مكتب تدريب هندسة عين شمس",
      ],
    ...
    },
    {
      name: "ق. أحمد علي",
      bio: [
        "المدير الإقليمي بشركة فيرتيميد انترناشونال",
        "خبير في بناء وتطوير مهارات القادة الشبان",
        "عضو مكتب تدريب الجامعة",
        "قائد منتخب الجامعة سابقاً",
      ],
    ...
    },
    {
      name: "ق. وليد رمضان",
      bio: [
        "محاضر دولي (PMP, PRMG) واستشاري إدارة المشروعات",
        "مدرب متألق في ديناميكيات فرق العمل",
        "قائد سابق لعشيرة جوالة هندسة عين شمس",
      ],
    ...
    },
    {
      ...
      bio: [
        "مهندسة طاقة متجددة",
        "متخصصة في التحفيز وإشعال الشغف وتوجيه الطاقات",
        "رائدة كبرى سابقاً بعشيرة الجوالة",
      ],
    ...
    },
    {
      name: "ق. أحمد بحري",
      bio: [
        "المستشار القانوني لبحرية القاهرة",
        "مستشار التخطيط الاستراتيجي وصناعة الرؤية المستقبلية",
        "مساعد كبير مفوضي الكشافة البحرية المصرية",
        "عضو مكتب تدريب جامعة عين شمس",
      ],
    ...
    },
    {
      name: "ق. يوسف شوكت",
      bio: [
        "Technical Office Team Leader | Civil Engineer",
        "مفوض مرحلة الجوالة ببحرية القاهرة",
        "قائد عشاير جامعة عين شمس سابقا",
        "قائد عشيرة هندسة سابقا",
        "عضو مكتب تدريب عشيرة جوالة هندسة عين شمس",
        "عضو مكتب تدريب عشيرة جوالة جامعة عين شمس",
      ],
    ...
    },
    {
      name: "ق. حمدي فتحي",
      bio: [
        "مدير عام بالبنك الأهلي المصري",
        "مستشار إدارة المخاطر وتأهيل قادة المستقبل",
        "قائد سابق لعشيرة الجوالة",
      ],
    ...
    },
    {
      ...
      bio: [
        "مدير مشاريع",
        "متخصص في قيادة التغيير وإدارة المقاومة المؤسسية",
        "رئيس لجنة المنح والشراكات بالاتحاد العام للكشافة والمرشدات",
      ],
    ...
    },
    {
      ...
      bio: [
        "مدير مشروعات",
        "خبير حل المشكلات المعقدة واتخاذ القرارات الاستراتيجية",
        "قائد سابق لعشيرة جوالة هندسة عين شمس",
      ],
  ...
  const scheduleDays = [
    ...
    },
    {
      ...
      items: [
        ...
        { time: "11:50 ص - 12:40 م", title: "المحاضرة 6: التحفيز وإشعال الشغف", instructor: "ق. مريم مانشي", duration: "50 دقيقة" },
        { time: "12:40 م - 02:00 م", title: "صلاة الجمعة وفترة الفطار", instructor: "-", duration: "80 دقيقة" },
        { time: "02:00 م - 02:50 م", title: "المحاضرة 7: التواصل الفعّال والعروض", instructor: "ق. أشرف أنور", duration: "50 دقيقة" },
        { time: "03:05 م - 04:05 م", title: "المحاضرة 8: التخطيط وصناعة الرؤية", instructor: "ق. أحمد بحري", duration: "60 دقيقة" },
        { time: "04:05 م - 04:30 م", title: "استراحة (صلاة العصر)", instructor: "-", duration: "25 دقيقة" },
        { time: "04:30 م - 05:00 م", title: "فقرة مع قيادة الدراسة", instructor: "-", duration: "30 دقيقة" },
        { time: "05:00 م - 05:50 م", title: "المحاضرة 9: الذكاءات المتعددة", instructor: "ق. يوسف شوكت", duration: "50 دقيقة" },
        { time: "06:05 م - 06:55 م", title: "المحاضرة 10: حل المشكلات واتخاذ القرار", instructor: "ق. أشرف أنور", duration: "50 دقيقة" },
        { time: "06:55 م - 08:10 م", title: "حلقة السمر الكشفية", instructor: "-", duration: "75 دقيقة" },
      ],
    },
    {
            ...
            >
              ...
              <div className="space-y-4 pt-2">
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="text-xs text-dark/70 font-semibold leading-relaxed min-h-[48px] text-right space-y-1">
                    {inst.bio.map((point, i) => (
                      <div key={i} className="flex items-start gap-1">
                        <span className="text-gold shrink-0 font-black">-</span>
                        <span>{point}</span>
                      </div>
                    ))}
                  </div>
