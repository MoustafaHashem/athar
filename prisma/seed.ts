...
async function main() {
  ...
  const instructorsData = [
    { name: "أشرف أنور", bio: "مدير عام المعلومات وقواعد البيانات بشركة جابكو للبترول - قائد ومحاضر متميز في التنمية البشرية وقيادة الذات والإرث الكشفي - قائد هيئة تدريب - عضو مكتب تدريب جامعة عين شمس - قائد مكتب تدريب جوالة هندسة عين شمس - قائد عشائر جامعة عين شمس سابقاً", imagePath: "/images/instructors/ashraf-anwar.png" },
